...
$itIsAContract = strstr($uri, '/');       // $pos contient alors url sans nom domaine
if ($itIsAContract == '/') $itIsAContract = '';     // si $pos vaut /, on le met a ''
define('DOL_URL_ROOT', $itIsAContract);
